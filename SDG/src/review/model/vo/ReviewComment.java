...
public class ReviewComment implements Serializable {
	...
	public ReviewComment(String memId, int reviewNo, String commentContent) {
		this.memId = memId;
		this.reviewNo = reviewNo;
		this.commentContent = commentContent;
	}
	public ReviewComment(int commentNo, String memId, String commentContent, int reviewNo) {
		this.commentNo = commentNo;
		this.memId = memId;
		this.reviewNo = reviewNo;
		this.commentContent = commentContent;
	}
	public ReviewComment(int commentNo, String memId, String commentContent) {
		this.commentNo = commentNo;
		this.memId = memId;
