...
public class Spaces {
	...
	public Spaces(int spc_det_no, int spc_no, int spc_type_no, int spc_loc_no, char spc_det_avail,
			String spc_det_content, char spc_det_shqring, char spc_det_holiday, int spc_det_size, int spc_det_capacity,
			int spc_cap_min, int spc_cpa_max, Date spc_date_start, Date spc_date_end, Date spc_det_date) {
		super();
